...
enum class ScriptVarType(
    ...
    TYPE_2(2, c = '2', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_13(13, c = 'O', type = BaseVarType.INTEGER, default = -1),
    SYNTH(14, "SYNTH", 'P', BaseVarType.INTEGER, -1),
    TYPE_15(15, c = 'Q', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_27(27, c = 'h', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_35(35, c = 'r', type = BaseVarType.LONG, default = -1L),
    ...
    TYPE_45(45, c = '\u0192', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_54(54, c = '\u00a2', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_65(65, c = '\u00e6', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_75(75, c = '\u00a4', type = BaseVarType.INTEGER, default = -1),
    TYPE_76(76, c = '\u00a5', type = BaseVarType.INTEGER, default = -1),
    TYPE_77(77, c = '\u00e8', type = BaseVarType.INTEGER, default = -1),
    TYPE_78(78, c = '\u00b9', type = BaseVarType.INTEGER, default = -1),
    TYPE_79(79, c = '\u00b0', type = BaseVarType.INTEGER, default = -1),
    TYPE_80(80, c = '\u00ec', type = BaseVarType.INTEGER, default = -1),
    TYPE_81(81, c = '\u00eb', type = BaseVarType.INTEGER, default = -1),
    TYPE_83(83, c = '\u00fe', type = BaseVarType.INTEGER, default = -1),
    TYPE_84(84, c = '\u00fd', type = BaseVarType.INTEGER, default = -1),
    TYPE_85(85, c = '\u00ff', type = BaseVarType.INTEGER, default = -1),
    TYPE_86(86, c = '\u00f5', type = BaseVarType.INTEGER, default = -1),
    TYPE_87(87, c = '\u00f4', type = BaseVarType.INTEGER, default = -1),
    TYPE_88(88, c = '\u00f6', type = BaseVarType.INTEGER, default = -1),
    GWC_PLATFORM(89, "GWC_PLATFORM", '\u00f2', BaseVarType.INTEGER, -1),
    TYPE_90(90, c = '\u00dc', type = BaseVarType.INTEGER, default = -1),
    TYPE_91(91, c = '\u00f9', type = BaseVarType.INTEGER, default = -1),
    TYPE_92(92, c = '\u00ef', type = BaseVarType.INTEGER, default = -1),
    TYPE_93(93, c = '\u00af', type = BaseVarType.INTEGER, default = -1),
    ...
    TYPE_115(115, c = '\u00bc', type = BaseVarType.LONG, default = -1L),
    TYPE_116(116, c = '\u00bd', type = BaseVarType.LONG, default = -1L),
    ...
    TYPE_209(209, "TYPE_209", '\u0000', BaseVarType.INTEGER, -1),
    ;
    ...
    companion object {
        ...
        init {
            values.forEach { type ->
                if (type.c == UNKNOWN_CHAR) return@forEach
                legacyMappings[TextUtils.charToCp1252(type.c).toInt() and 0xff] = type
            }
        }

        const val UNKNOWN_CHAR: Char = '\u0000'

        fun getById(id: Int) = values.firstOrNull { it.id == id }

        fun getByChar(c: Char): ScriptVarType {
            if (c == 'O') return OBJ
            val slot = TextUtils.charToCp1252(c).toInt() and 0xff
            return legacyMappings[slot] ?: throw NullPointerException("No ScriptVarType found for char '$c'")
        }
    }
