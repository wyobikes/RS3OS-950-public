    ...
    override fun channelRead0(ctx: ChannelHandlerContext, msg: HandshakeRequest) {
        ...
        when (msg.type) {
            HandshakeType.JS_5 -> {
                ...
                DiagnosticLog.stage(ctx.channel(), DiagnosticLog.Stage.JS5, "(handshake type JS_5)")
                DiagnosticLog.attachJs5(ctx.channel())
            }
            HandshakeType.LOGIN -> {
                ...
                DiagnosticLog.stage(ctx.channel(), DiagnosticLog.Stage.LOGIN, "(handshake type LOGIN)")
