...
class NpcForceMovementBlock(
    ...
    init {
        ...
        require(angle in 0..0x3fff) {
            "angle $angle is outside 0..0x3fff"
        }
    }
    ...
    override fun encode950(buffer: GamePacketBuilder) {
        ScalarModes.putU8(buffer, 2, a1)
        ScalarModes.putU8(buffer, 2, a2)
        ScalarModes.putU8(buffer, 0, a3)
        ScalarModes.putU8(buffer, 0, b1)
        ScalarModes.putU8(buffer, 2, b2)
        ScalarModes.putU8(buffer, 0, b3)
        ScalarModes.putU16(buffer, 1, c1)
        ScalarModes.putU16(buffer, 1, c2)
